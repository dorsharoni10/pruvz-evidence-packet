...
export const SUPPORTED_VERSIONS = ['1.2.0', '1.1.0', '1.0.0']
...
export function packetConsistencyErrors(packet) {
  ...
  if (action.review === undefined) {
    ...
    errors.push(...reviewConsistencyErrors(action, decisionItems))
  }
 ...
 */
function reviewConsistencyErrors(action, decisionItems) {
  const errors = []
